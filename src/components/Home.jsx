    ...
    <div name='home' className='bg-[#0a192f] w-full h-screen'>
      <div className='max-w-[1000px] mx-auto px-8 flex flex-col justify-center h-full'>
        ...
        <p className='py-4 max-w-[700px] text-[#8892b0]'>
          As a skilled web developer, I specialize in crafting modern solutions that solve complex
          business problems. With a strong focus on collaboration and independence, I thrive in both
          team-based and self-directed projects.
        </p>
        <div className='mt-2'>
